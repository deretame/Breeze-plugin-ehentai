...
export interface BreezeSelection {
  ...
  filter(callback: (index: number, element: BreezeSelection) => boolean): BreezeSelection;
  ...
  map<T>(callback: (index: number, element: BreezeSelection) => T): BreezeMappedResult<T>;
}
